...
df_evaluation = ar_evaluation(ar_folder_path, 'rolling',train_list_rolling,val_list_rolling,test_data,
                              df_close,
                                 df_evaluation)

#%% Evaluate with expanding window
df_evaluation = ar_evaluation(ar_folder_path, 'expanding',train_list_expanding,val_list_expanding,
                              test_data, df_close,
                                 df_evaluation)
